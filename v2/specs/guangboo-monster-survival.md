...
- The first playable mode is `survival`: 4 players, 1 life each, last surviving player wins.
...
- The lobby accepts a nickname and joins automatic matchmaking.
- The server starts a match when 4 queued players are available.
